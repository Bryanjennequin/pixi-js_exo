...
export const platInfo = [
  {
    ...
    classique: [
      { x: 1200, y: _height / 2, size: "grande", moveX: false, moveY: false, falling: false, delay: 0 },
      { x: 1500 + platSize.big, y: _height / 2, size: "moyenne", moveX: false, moveY: false, falling: false, delay: 0 },
      { x: 1500 + platSize.big + platSize.big, y: _height / 2 + 200, size: "petite", moveX: false, moveY: false, falling: false, delay: 0 },
      { x: 1500 + platSize.big + platSize.big + platSize.big + 200, y: _height / 2, size: "grande", moveX: false, moveY: true, falling: false, delay: 0 },
      { x: 1500 + platSize.big + platSize.big + platSize.big + 200 + platSize.big + 200, y: _height / 2 - 200, size: "grande", moveX: false, moveY: false, falling: false, delay: 0 },
